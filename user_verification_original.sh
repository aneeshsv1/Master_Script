...
sleep 3
SSH_ACCESS=`cat /etc/ssh/sshd_config | egrep -i "AllowUsers|DenyUsers|AllowGroups"| awk '{print $2}'` #===========================>>>sshd_config wont have the user information
if [[ $selection == $SSH_ACCESS ]] 
then
...
fi #==========================================================================================================================================>> This will not ensure if user has been sudo granted directly
if [[ $Admin -ne 0  ]]
 then
